...
:root{--surface:#1e1e20;--surface-2:#2a2a2d;--surface-3:#3a3a40;--ink:#d4d4d4;--muted:#9a9aa2;--rule:#4a4a50;--primary:#3b82f6;--error:#f44747;--success:#4ec9b0;--radius:10px;--dur:140ms}
[data-theme="light"]{--surface:#f6f6f8;--surface-2:#ededf0;--surface-3:#e2e2e6;--ink:#222226;--muted:#62626a;--rule:#c8c8ce}
[data-contrast="true"]{--muted:var(--ink);--rule:#808080}
